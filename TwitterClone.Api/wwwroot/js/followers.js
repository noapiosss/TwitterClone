...
const userFollowersWrapper = document.getElementById("followers-wrapper");

async function BuildPage(inputUsername)
{
    const userFollowers = await fetch(`${window.location.origin}/api/${inputUsername}/followers`)
    ...
    userFollowers.forEach(username => 
    {
        ...
        userFollowersWrapper.appendChild(userWrapper);
    });
}